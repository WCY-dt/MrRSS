export interface TranslationMessages {
  ...
  rsshub: string;
  rsshubApiKey: string;
  rsshubApiKeyDesc: string;
  rsshubApiKeyPlaceholder: string;
  rsshubEnabled: string;
  rsshubEnabledDesc: string;
  rsshubFallbackEnabled: string;
  rsshubFallbackEnabledDesc: string;

...
const en: TranslationMessages = {
  ...
  rsshubApiKeyDesc: 'RSSHub API key (if your instance requires authentication)',
  rsshubApiKeyPlaceholder: 'Enter API key (optional)',
  rsshubEnabled: 'Enable RSSHub Integration',
  rsshubEnabledDesc: 'Use RSSHub as a fallback option for RSS feeds',
  rsshubFallbackEnabled: 'Enable Fallback',
  rsshubFallbackEnabledDesc: 'Automatically use RSSHub when RSS cannot be found',
  rsshubInstanceUrl: 'RSSHub Instance URL',
  rsshubInstanceUrlDesc: 'URL of your RSSHub instance',
  rsshubInstanceUrlPlaceholder: 'https://rsshub.app',
  rsshubTestConnectionDesc: 'Test connection and authentication to RSSHub instance',
  rsshubTestFailed: 'Connection test failed',
  rsshubTestSuccess: 'Connection test successful',
  rsshubUsageHint:
    'Simply add RSSHub routes directly, e.g., https://rsshub.app/weibo/user/123. See',
  rsshubUsageHintLink: 'RSSHub Documentation',
  'rsshub.route_selector.title': 'Select RSSHub Route',
  'rsshub.route_selector.subtitle': 'Found {count} RSSHub route(s) for this URL',
  'rsshub.route_selector.original_url': 'Original URL',
  'rsshub.route_selector.recommended': 'Recommended',
  'rsshub.route_selector.high_match': 'High Match',
  'rsshub.route_selector.medium_match': 'Medium Match',
  'rsshub.route_selector.low_match': 'Low Match',
  'rsshub.route_selector.view_docs': 'View Documentation',
  'rsshub.route_selector.click_to_select': 'Click to select this route',
  'rsshub.loading_routes': 'Finding available routes...',
  'rsshub.available_routes': 'Available RSSHub Routes',
  'rsshub.recommended': 'Recommended',
  general: 'General',

...
const en: TranslationMessages = {
  ...
  minifluxSync: 'Miniflux Sync',
  minifluxSyncDesc: 'Sync feeds and articles with a Miniflux server',
  minifluxServerUrl: 'Server URL',
  minifluxServerUrlDesc: 'Your Miniflux server URL',
  minifluxServerUrlPlaceholder: 'https://miniflux.example.com',
  minifluxApiKey: 'API Key',
  minifluxApiKeyDesc: 'Generate in Miniflux Settings > API Keys',
  minifluxApiKeyPlaceholder: 'Enter API key',
  minifluxSyncSuccess: 'Miniflux sync successful',
  minifluxSyncFailed: 'Miniflux sync failed',
  minifluxMissingCredentials: 'Please enter Miniflux server URL and API key',
  fromFeed: 'From Feed',
  general: 'General',

...
const zh: TranslationMessages = {
  ...
  minifluxSync: 'Miniflux 同步',
  minifluxSyncDesc: '与 Miniflux 服务器同步订阅源和文章',
  minifluxServerUrl: '服务器地址',
  minifluxServerUrlDesc: '您的 Miniflux 服务器地址',
  minifluxServerUrlPlaceholder: 'https://miniflux.example.com',
  minifluxApiKey: 'API 密钥',
  minifluxApiKeyDesc: '在 Miniflux 设置 > API 密钥中生成',
  minifluxApiKeyPlaceholder: '输入 API 密钥',
  minifluxSyncSuccess: 'Miniflux 同步成功',
  minifluxSyncFailed: 'Miniflux 同步失败',
  minifluxMissingCredentials: '请输入 Miniflux 服务器地址和 API 密钥',
  fromFeed: '来自订阅源',
  general: '常规',

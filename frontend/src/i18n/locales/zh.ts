...
const zh: TranslationMessages = {
  ...
  rsshub: 'RSSHub',
  rsshubApiKey: 'API 密钥',
  rsshubApiKeyDesc: 'RSSHub API 密钥（如果实例需要认证）',
  rsshubApiKeyPlaceholder: '输入 API 密钥（可选）',
  rsshubEnabled: '启用 RSSHub 集成',
  rsshubEnabledDesc: '使用 RSSHub 作为 RSS 源的回退选项',
  rsshubFallbackEnabled: '启用回退机制',
  rsshubFallbackEnabledDesc: '当无法找到 RSS 时自动使用 RSSHub',
  rsshubInstanceUrl: 'RSSHub 实例地址',
  rsshubInstanceUrlDesc: '您的 RSSHub 实例 URL',
  rsshubInstanceUrlPlaceholder: 'https://rsshub.app',
  rsshubTestConnectionDesc: '测试与 RSSHub 实例的连接和认证',
  rsshubTestFailed: '连接测试失败',
  rsshubTestSuccess: '连接测试成功',
  rsshubUsageHint:
    '使用方法：直接添加 RSSHub 路由，例如 https://rsshub.app/weibo/user/123。完整路由列表请参考',
  rsshubUsageHintLink: 'RSSHub 文档',
  'rsshub.route_selector.title': '选择 RSSHub 路由',
  'rsshub.route_selector.subtitle': '为该网址找到 {count} 个 RSSHub 路由',
  'rsshub.route_selector.original_url': '原始网址',
  'rsshub.route_selector.recommended': '推荐',
  'rsshub.route_selector.high_match': '高匹配',
  'rsshub.route_selector.medium_match': '中等匹配',
  'rsshub.route_selector.low_match': '低匹配',
  'rsshub.route_selector.view_docs': '查看文档',
  'rsshub.route_selector.click_to_select': '点击选择此路由',
  'rsshub.loading_routes': '正在查找可用路由...',
  'rsshub.available_routes': '可用的 RSSHub 路由',
  'rsshub.recommended': '推荐',
  general: '常规',
